...
async function main() {
  ...
  if (disputeId === undefined) {
    console.error("USAGE: node call-list-dispute-actions.js <disputeId>");
    process.exit(1);
  }

  console.log("=== Client test: listDisputeActionsEU ===");
