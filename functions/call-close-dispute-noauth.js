/**
 * call-close-dispute-noauth.js
 *
 * CMD:
 *   cd /d C:\Users\teach\xdrivee-backend\functions
 *   node call-close-dispute-noauth.js K9E29iOi50853amb1gT6
 */
...
async function main() {
  ...
  if (disputeId === undefined) {
    console.error("USAGE: node call-close-dispute-noauth.js <disputeId>");
    process.exit(1);
  }

  console.log("=== Client test: closeDisputeEU [no auth] ===");
