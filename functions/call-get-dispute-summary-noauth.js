/**
 * call-get-dispute-summary-noauth.js
 *
 * CMD:
 *   cd /d C:\Users\teach\xdrivee-backend\functions
 *   node call-get-dispute-summary-noauth.js <disputeId>
 */
...
async function main() {
  ...
  if (disputeId === undefined) {
    console.error("USAGE: node call-get-dispute-summary-noauth.js <disputeId>");
    process.exit(1);
  }

  console.log("=== Client test: getDisputeSummaryEU [no auth] ===");
