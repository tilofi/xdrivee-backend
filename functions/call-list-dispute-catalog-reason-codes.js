/**
 * call-list-dispute-catalog-reason-codes.js
 *
 * CMD:
 *   cd /d C:\Users\teach\xdrivee-backend\functions
 *   set "XD_EMAIL=user@example.com"
 *   set "XD_PASS=YOUR_PASSWORD"
 *   node call-list-dispute-catalog-reason-codes.js <role> <category>
 */
...
async function main() {
  ...
  if (role === undefined || category === undefined) {
    console.error("USAGE: node call-list-dispute-catalog-reason-codes.js <role> <category>");
    process.exit(1);
  }

  console.log("=== Client test: listDisputeCatalogReasonCodesEU ===");
