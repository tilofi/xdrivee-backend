/**
 * call-client-create-dispute-message.js
 *
 * CMD:
 *   cd /d C:\Users\teach\xdrivee-backend\functions
 *   set "XD_EMAIL=chettouhlotfi30@gmail.com"
 *   set "XD_PASS=YOUR_PASSWORD"
 *   node call-client-create-dispute-message.js BCWcpMNbEkPnCplySPC3 "hello from client"
 */
...
async function main() {
  ...
  if (!disputeId || !text) {
    console.error('USAGE: node call-client-create-dispute-message.js <disputeId> "text"');
    process.exit(1);
  }

  console.log("=== Client test: createDisputeMessageEU ===");
  ...
  const fn = httpsCallable(functions, "createDisputeMessageEU");
