...
async function main() {
  ...
  if (disputeId === undefined) {
    console.error("USAGE: node call-reject-dispute.js <disputeId>");
    process.exit(1);
  }

  console.log("=== Client test: rejectDisputeEU ===");
