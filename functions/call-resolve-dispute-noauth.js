/**
 * call-resolve-dispute-noauth.js
 *
 * CMD:
 *   cd /d C:\Users\teach\xdrivee-backend\functions
 *   node call-resolve-dispute-noauth.js K9E29iOi50853amb1gT6 resolved
 */
...
async function main() {
  ...
  if (disputeId === undefined || status === undefined) {
    console.error("USAGE: node call-resolve-dispute-noauth.js <disputeId> <status> [resolutionNote]");
    process.exit(1);
  }

  console.log("=== Client test: resolveDisputeEU [no auth] ===");
