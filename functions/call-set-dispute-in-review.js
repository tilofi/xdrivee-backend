...
async function main() {
  ...
  if (disputeId === undefined) {
    console.error("USAGE: node call-set-dispute-in-review.js <disputeId>");
    process.exit(1);
  }

  console.log("=== Client test: setDisputeInReviewEU ===");
