...
async function main() {
  ...
  if (disputeId === undefined) {
    console.error("USAGE: node call-list-dispute-messages-admin.js <disputeId> [limit]");
    process.exit(1);
  }
  ...
  console.log("=== Client test: listDisputeMessagesAdminEU ===");
