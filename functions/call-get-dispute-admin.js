...
async function main() {
  ...
  if (disputeId === undefined) {
    console.error("USAGE: node call-get-dispute-admin.js <disputeId>");
    process.exit(1);
  }

  console.log("=== Client test: getDisputeAdminEU ===");
