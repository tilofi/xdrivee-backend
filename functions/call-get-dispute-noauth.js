/**
 * call-get-dispute-noauth.js
 *
 * CMD:
 *   cd /d C:\Users\teach\xdrivee-backend\functions
 *   node call-get-dispute-noauth.js K9E29iOi50853amb1gT6
 */
...
async function main() {
  ...
  if (disputeId === undefined) {
    console.error("USAGE: node call-get-dispute-noauth.js <disputeId>");
    process.exit(1);
  }

  console.log("=== Client test: getDisputeEU [no auth] ===");
  console.log("disputeId:", disputeId);

  const app = initializeApp(firebaseConfig);
  const functions = getFunctions(app, "europe-west1");
  const fn = httpsCallable(functions, "getDisputeEU");
